package io.github.mcengine.extension.library.artificialintelligence.example.listener;
...
public class LibraryListener implements Listener {
     ...
     */
    public LibraryListener(Plugin plugin, MCEngineExtensionLogger logger) {
        this.plugin = plugin;
        this.logger = logger;
    }
